...
mkdir -p merge_test
usearch -fastq_mergepairs *_R1_paired.fastq  -relabel @ -report usearch_merge/merge.log -fastqout usearch_merge/merged.fastq -tabbedout usearch_merge/detail_pairs.log

#Move merge test logfile into usearch dir.
mv mer usearch_merge/
mv usearch_merge/ ../
cd ..
...
# # Construct Phylogenetic tre#! usr/bin/env/bash
